...
const profiles = [
  {
    ...
    payload: {
      ...
      test_score: { name: "GRE", status: "taken", score: 335 },
    },
  },
  {
    label: "Mid CGPA, tier-2 college, no GRE yet, targeting US MS CS + MS Data Science",
    payload: {
      degree: "B.Tech",
      ...
      target_intake: "Fall 2027",
      test_score: { name: "GRE", status: "not_taken" },
    },
  },
  {
    label: "Low CGPA, targeting UK MS Analytics, planning to take IELTS",
    payload: {
      degree: "B.Sc",
      ...
      target_intake: "Fall 2027",
      test_score: { name: "IELTS", status: "planned" },
    },
  },
  {
  ...
  },
  {
    ...
    payload: {
      ...
      target_programs: ["MBA"],
      target_intake: "Fall 2027",
      test_score: { name: "GMAT", status: "taken", score: 700 },
    },
  },
];
